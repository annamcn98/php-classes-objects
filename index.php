    ...
    <?php
		 ...
		 */
			...
			class Car {
				...
				public $brand = "Volvo";
				public $originCountry = "Sweden";
				public $slogan;


			public function getPresentation() {
				return "{$this->brand}, a car brand originated in {$this->originCountry}. <br>";
			...
			public function getSlogan() {
				return "{$this->$brand}, {$this->$slogan}. <br>";
			}

			public function __construct(string $brand = "Volvo", string $originCountry = "Sweden", string $slogan ="") {
				$this->brand 			= $brand;
				$this->originCountry 	= $originCountry;
				$this->slogan 			= $slogan;
			}
